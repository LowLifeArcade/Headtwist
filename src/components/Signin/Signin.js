      ...
      <div className="measure">
        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
          ...
          <div className="mt3">
            ...
            <input 
            className="pa1 input-reset ba bg-transparent hover-bg-transparent hover-transparent w-100 b--black-20" 
            type="email" 
            name="email"  
            id="email" 
          ...
          <div className="mv3">
            ...
            <input 
            className="b pa1 input-reset ba bg-transparent hover-bg-transparent hover-white w-100 b--black-20" 
            type="password" 
            name="password"  
            id="password" 
          ...
          <label className="pa0 ma0 lh-copy f6 pointer"><input className="bg-transparent" type="checkbox" /> Remember me</label>
        </fieldset>
        <div className="">
          <input 
